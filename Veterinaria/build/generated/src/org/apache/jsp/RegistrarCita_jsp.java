...
public final class RegistrarCita_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <div class=\"col-md-12\">\r\n");
      out.write("                                <form class=\"cmxform\" id=\"signupForm\" method=\"POST\" onsubmit=\"check(event, this)\" action=\"CitasController?action=create\">\r\n");
      out.write("                                    <div class=\"col-md-6\">                                        \r\n");
      out.write("                                        <div class=\"form-group form-animate-text\">\r\n");
      out.write("                                            <input type=\"text\" class=\"form-text dateAnimate\" id=\"fhentrada\" name=\"fhentrada\" required>\r\n");
      out.write("                                            <span class=\"bar\"></span>\r\n");
      out.write("                                            <label><span class=\"fa fa-calendar\"></span> Fecha Entrada</label>\r\n");
      out.write("                                        </div>                                        \r\n");
      out.write("                                        <div class=\"form-group form-animate-text\">\r\n");
      out.write("                                            <input type=\"text\" class=\"form-text time\" name=\"tmentrada\" id=\"tmentrada\" required>\r\n");
      out.write("                                            <span class=\"bar\"></span>\r\n");
      out.write("                                            <label><span class=\"fa fa-clock-o\"></span> Hora Entrada</label>\r\n");
      out.write("                                        </div>\r\n");
      out.write("\r\n");
      out.write("                                        <div class=\"col-sm-12 padding-0\">                                                                                      \r\n");
      out.write("                                            <span class=\"bar\"></span>\r\n");
      out.write("                                            <label>Mascota</label><br>\r\n");
      out.write("                                            <select class=\"select2-A\" style=\"width: 100%;\" name=\"mascota\">        \r\n");
      out.write("                                                ");
      ...
      out.write("                                    <div class=\"col-md-6\">  \r\n");
      out.write("                                        <div class=\"form-group form-animate-text\">\r\n");
      out.write("                                            <input type=\"text\" class=\"form-text dateAnimate\" name=\"fhsalida\" value=\"2017-10-30\" id=\"fhsalida\" required>\r\n");
      out.write("                                            <span class=\"bar\"></span>\r\n");
      out.write("                                            <label><span class=\"fa fa-calendar\"></span> Fecha Salida</label>\r\n");
      out.write("                                        </div>                                        \r\n");
      out.write("                                        <div class=\"form-group form-animate-text\">\r\n");
      out.write("                                            <input type=\"text\" class=\"form-text time\" name=\"tmsalida\" id=\"tmsalida\" required>\r\n");
      out.write("                                            <span class=\"bar\"></span>\r\n");
      out.write("                                            <label><span class=\"fa fa-clock-o\"></span> Hora Salida</label>\r\n");
      out.write("                                        </div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("                                        <div class=\"col-sm-12 padding-0\">\r\n");
      ...
      out.write("                    <option value='cupertino' >Cupertino</option>\r\n");
      out.write("                    <option value='dark-hive'>Dark Hive</option>\r\n");
      out.write("                    <option value='dot-luv' selected>Dot Luv</option>\r\n");
      ...
      out.write("            <button class=\"btn btn-primary\" data-toggle=\"modal\" id=\"buttonmodal\" data-target=\"#mimodalejemplo\" style=\"display: none;\">Agregar Cita</button>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
 ...
 ArrayList listar = (ArrayList) request.getAttribute("ArrayCitas");
      ...
      out.write("                                                                if (!confirm(\"Are you sure about this change?\")) {\r\n");
      ...
      out.write("\r\n");
      out.write("                                                                if (date.add(1, 'days') <= new Date()) {\r\n");
      out.write("                                                                    //alert(\"\");\r\n");
      out.write("                                                                } else {\r\n");
      out.write("                                                                    date.subtract(1, 'days');\r\n");
      out.write("                                                                    //alert(\"Si se puede\"+date.format());\r\n");
      out.write("//                                                                    Ventana modal        \r\n");
      out.write("                                                                    var elem = document.getElementById('buttonmodal');\r\n");
      out.write("                                                                    elem.click();\r\n");
      out.write("                                                                    var fhsalida = document.getElementById('fhentrada').value = date.format();\r\n");
      out.write("//                                                                \r\n");
      out.write("                                                                }\r\n");
      out.write("\r\n");
      out.write("//                                                                        alert(\"salio\");                                                                        \r\n");
      out.write("//                                                                        var elem = document.getElementById('mimodalejemplo');\r\n");
      out.write("//                                                                        elem.style.display = 'block';\r\n");
      out.write("//                                                                        \r\n");
      out.write("//                                                                        \r\n");
      out.write("//                                                                        var actual = new Date());\r\n");
      out.write("//                                                                        var calendar = date.format();\r\n");
      out.write("//                                                                        alert(\"Fecha actual\"+actual+\" Calendar: \"+calendar);\r\n");
      out.write("//                                                                        //document.getElementById('fechajava').value;\r\n");
      out.write("//                                                                        if(date.format() > ){\r\n");
      out.write("//                                                                            alert(\"Se puede\");\r\n");
      out.write("\r\n");
      out.write("//                                                               Ventana modal        \r\n");
      out.write("//                                                                var elem = document.getElementById('buttonmodal');\r\n");
      out.write("//                                                                elem.click();\r\n");
      ...
      out.write("            dropdownParent: $(\"#mimodalejemplo\")\r\n");
      out.write("\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("    //$('.min-date').bootstrapMaterialDatePicker({format: 'HH:mm', minDate: new Date(), time: false, });\r\n");
      out.write("//    $('.min-date').bootstrapMaterialDatePicker({ format : 'DD/MM/YYYY HH:mm', minDate : new Date() });\r\n");
      out.write("    $('.datetime').bootstrapMaterialDatePicker({format: 'dddd DD MMMM YYYY - HH:mm', animation: true});\r\n");
      out.write("    //$('.datetime').bootstrapMaterialDatePicker({ format : 'YYYY MMMM dddd - HH:mm',animation:true});\r\n");
      out.write("    $('.time').bootstrapMaterialDatePicker({date: false, format: 'HH:mm', animation: true});\r\n");
      out.write("    $('.dateAnimate').bootstrapMaterialDatePicker({weekStart: 0, time: false, minDate: new Date(), animation: true});\r\n");
      out.write("\r\n");
      out.write("    function check(e, f) {\r\n");
      out.write("        var fhentrada = document.getElementById('fhentrada').value + \" \" + document.getElementById('tmentrada').value;\r\n");
      out.write("        var fhsalida = document.getElementById('fhsalida').value + \" \" + document.getElementById('tmsalida').value;\r\n");
      out.write("        /*if (fhentrada < fhsalida) {\r\n");
      out.write("         alert(\"Si se pudo\");\r\n");
      out.write("         alert(\"Entrada: \" + fhentrada);\r\n");
      out.write("         alert(\"Salida \" + fhsalida);\r\n");
      out.write("         } else {\r\n");
      out.write("         alert(\"No se pudo\");\r\n");
      out.write("         //            alert(\"Entrada: \" + fhentrada);\r\n");
      out.write("         //            alert(\"Salida \" + fhsalida);\r\n");
      out.write("         e.preventDefault();\r\n");
      out.write("         }*/\r\n");
      out.write("        var f = document.getElementById('tmentrada').value;\r\n");
      out.write("        var time = new Date();\r\n");
      out.write("        var hora = time.getHours();\r\n");
      out.write("        var minuto = time.getMinutes();\r\n");
      out.write("        var finaltime = hora+\":\"+minuto;\r\n");
      out.write("//        if(f > d.getHours()){\r\n");
      out.write("//            alert(\"Se puede\");\r\n");
      out.write("//        }else{\r\n");
      out.write("//               alert(\"No se puede\");\r\n");
      out.write("//        }\r\n");
      out.write("            if(f > finaltime){\r\n");
      out.write("                alert(\"se puede\");\r\n");
      out.write("            }else{\r\n");
      out.write("                alert(\"no se puede\");\r\n");
      out.write("            }\r\n");
      out.write("        alert(f+\" \"+ finaltime);\r\n");
      out.write("        e.preventDefault();\r\n");
      out.write("\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
