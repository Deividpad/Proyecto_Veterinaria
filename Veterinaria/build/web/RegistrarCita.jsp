    ...
    <div class="modal fade" id="mimodalejemplo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">        
                                ...
                                <form class="cmxform" id="signupForm" method="POST" action="CitasController?action=create">
                                    <div class="col-md-6">                                        
                                        <div class="form-group form-animate-text">
                                            <input type="text" class="form-text dateAnimate" id="fhsalida" required>
                                            <span class="bar"></span>
                                        ...
                                        <div class="form-group form-animate-text">
                                            ...
                                            <span class="bar"></span>
                                            <label><span class="fa fa-clock-o"></span> Timeee Picker</label>
                                        </div>
        ...
        <div id='top'>
            ...
            <div class='left'>
                ...
                <button class="btn btn-primary" data-toggle="modal" id="buttonmodal" data-target="#mimodalejemplo">Agregar Cita</button>
            </div>
...
//                                                                        elem.style.display = 'block';
                                                                    ...
                                                                    elem.click();
                                                                    var fhsalida = document.getElementById('fhsalida').value = date.format();
