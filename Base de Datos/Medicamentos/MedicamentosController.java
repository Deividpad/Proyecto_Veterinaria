...
//      Medicamentos Medi = new Medicamentos(per, nombre, laboratorio, lote, fecha);
        Medicamentos Medi = new Medicamentos(Cit, Ho, per, nombre, laboratorio, lote, fecha);
    ...
    public void admin(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            request.getRequestDispatcher("adminM.jsp").forward(request, response);//envia informacion a admin jsp
